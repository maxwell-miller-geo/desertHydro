...
# WatershedElements <- file.path("inst/extdata/DemoElements")
print("Check for vignette!")
# desertHydro:::arid_model(ModelFolder = ModelFolder, WatershedElements = WatershedElements,crop = F)
```

# Use vignettes -
build_rmd("vignette/vignettename")
