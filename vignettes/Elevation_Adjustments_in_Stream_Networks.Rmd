...
```{r}
demExt <- terra::extract(dem, stream_network)
demAdjusted <- terra::extract(mod_dem, stream_network)
...
carve_dem <- smoothStream(stream_network, mod_dem_path)
carveExtract <- terra::extract(carve_dem, stream_network)
