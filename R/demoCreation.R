...
# grid[5,] <- grid[5,] - 1  # Carve the center channel
...
# terra::writeRaster(test, filename = "./inst/extdata/demo_dem.tif", overwrite = T)

# exampleDEM <- terra::rast(file.path(outfile, "demo_dem.tif"))
